...
abstract class ModelUnitRealize implements ModelUnit{
    ...
    public ModelUnitRealize(SavedText ST1, SavedText ST2)
    {
        assert NUMOFTEXTS > 1;
    ...
    public abstract void open(String s, int i) throws IOException, IndexOutOfBoundsException;
    public abstract void save(String s, int i) throws IOException, IndexOutOfBoundsException;
    public abstract void save(int i) throws IOException;
    public abstract String filepath(int i);
}
